...
public class Delantero extends jugador {
    ...
    public void ratingtiene() {
        ...
        while (intentos < 1000) {
            ...
            if (resultado1 >= 70) {
                this.setRitmo(resultado1);
            }
            if (resultado2 >= 70) {
                this.setDisparo(resultado2);
            }
            if (resultado3 >= 70) {
    ...
    public void ratingnotiene() {
        ...
        while (intentos < 1000) {
            ...
            if (resultadon3 >= 70) {
                this.setPassing(resultadon3);
            }
            if (resultadon4 >= 70) {
                this.setVision(resultadon4);
            }
            if (resultadon5 >= 70) {
                this.setFisico(resultadon5);
            }
            if (resultadon6 >= 70) {
                this.setEntrada(resultadon6);
            }
